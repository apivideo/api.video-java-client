...
public class VideosAsyncTest extends AbstractTest {
    ...
    class Update {
        ...
        public void addMetadata() throws ApiException, ExecutionException, InterruptedException, TimeoutException {
            ...
            apiClient.videos()
                    .updateAsync(testVideo.getVideoId(),
                            ...
                            new ApiCallback<Video>() {
                                ...
                                @Override
                                public void onSuccess(Video result, int statusCode,
                                        Map<String, List<String>> responseHeaders) {
    ...
    class ListWithMetadata {
        ...
        @Test
        public void listMetadataNotFound()
                throws ApiException, ExecutionException, InterruptedException, TimeoutException {
    ...
    class ListWithTags {
        ...
        @BeforeAll
        public void createVideo() throws ApiException {
            this.testVideo = apiClient.videos().create(new VideoCreationPayload().tags(Arrays.asList("tag1", "tag2"))
                    .title("[Android-SDK-tests] list tags"));
        }

        @Test
        public void listTagNotFound() throws ApiException, ExecutionException, InterruptedException, TimeoutException {
            CompletableFuture<Page<Video>> futurePage = new CompletableFuture<Page<Video>>();
            apiClient.videos().list().tags(Collections.singletonList("valueNotFound"))
                    .executeAsync(new ApiCallback<Page<Video>>() {
                        @Override
                        public void onFailure(ApiException e, int statusCode,
                                Map<String, List<String>> responseHeaders) {
                            futurePage.completeExceptionally(e);
                        ...
                        @Override
                        public void onSuccess(Page<Video> result, int statusCode,
                                Map<String, List<String>> responseHeaders) {
                            futurePage.complete(result);
                        }
    ...
    class Thumbnail {
        ...
        public void createVideo() throws ApiException {
            this.testVideo = apiClient.videos()
                    .create(new VideoCreationPayload().title("[Android-SDK-tests] thumbnail"));
        }

        @Test
        public void uploadThumbnail()
                throws ApiException, IOException, ExecutionException, InterruptedException, TimeoutException {
