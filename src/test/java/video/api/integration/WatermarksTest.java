...
public class WatermarksTest extends AbstractTest {
    ...
    public void createVideoWithWatermark() throws ApiException {
        ...
        Video video = this.apiClient.videos().create(new VideoCreationPayload().title("[java] video with watermark")
                .watermark(new VideoWatermark().bottom("10px").id(this.testWatermark.getWatermarkId())));
